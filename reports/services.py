...
def generate_transaction_statement_pdf(user, organization=None, filters=None):
    ...
    file_name = f"ratiba-statement-{summary['date_from']}-to-{summary['date_to']}.pdf"
...
class _StatementPdf:
    ...
    def _footer(self, page_number, page_count):
        self._text("Generated by Ratiba. For support, quote the transaction ID shown on this statement.", 48, 32, 6, color=self.red)
