...
PAYMENT_MICROSERVICE_TIMEOUT_SECONDS = float(os.environ.get("PAYMENT_MICROSERVICE_TIMEOUT_SECONDS", "8"))
PAYMENT_MICROSERVICE_INLINE_DISPATCH = _env_bool("PAYMENT_MICROSERVICE_INLINE_DISPATCH", False)
...
PESAWAY_SYSTEM_SLUG = os.environ.get("PESAWAY_SYSTEM_SLUG") or os.environ.get("SYSTEM_SLUG", "qb")
PESAWAY_COLLECTION_EVENT_SLUG = os.environ.get("PESAWAY_COLLECTION_EVENT_SLUG", "load-wallet")
PESAWAY_B2C_EVENT_SLUG = os.environ.get("PESAWAY_B2C_EVENT_SLUG", "b2c")
PESAWAY_B2B_EVENT_SLUG = os.environ.get("PESAWAY_B2B_EVENT_SLUG", "b2b")
PESAWAY_BANK_EVENT_SLUG = os.environ.get("PESAWAY_BANK_EVENT_SLUG", "bank-transfer")
